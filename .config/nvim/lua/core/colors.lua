...
function ColorMyDefaults()
  ...
  vim.api.nvim_set_hl(0, 'PmenuSel', { fg = theme.base_30.black, bg = theme.base_30.pmenu_bg, blend = 0 })
...
function ColorMyCmp()
  ...
  vim.api.nvim_set_hl(0, 'CmpNormal', { bg = transparent and 'none' or theme.base_30.darker_black })
  vim.api.nvim_set_hl(0, 'CmpDocNormal', { bg = transparent and 'none' or theme.base_30.darker_black })
